//자바파일 복사 buf사용.. 대상파일 git에 있으면 경로 써줘야 알아 쳐먹음 
...
public class FileCopierVerNIO {
	public static void main(String[] args) {
		...
		Path src = Paths.get("C://Users//User//git//20180713//Test1//src//FileCopierVerNIO.java");
		
		System.out.println("사본이름 : ");
		Path dst = Paths.get("C://Users//User//git//20180713//Test1//src//Copy.java");
